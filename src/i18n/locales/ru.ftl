...
qs-title =
    ...
    Выбери раздел. Изменения действуют на каждую новую цитату здесь.
qs-on = Вкл.
qs-off = Выкл.
qs-cat-appearance = 🎨 Вид
qs-cat-content = ✂️ Что цитировать
qs-cat-privacy = 🔒 Приватность
qs-cat-group = 👥 Группа
qs-cat-appearance-desc =
    <b>🎨 Вид</b>

    • <b>Формат</b> — стикер, изображение или PNG-файл.
    • <b>Цвет</b> — фон цитаты.
    • <b>Бренд эмодзи</b> — как рисуются эмодзи (Apple, Google…).
    • <b>Эмодзи стикера</b> — эмодзи, прикреплённое к сохранённым стикерам.
qs-cat-content-desc =
    <b>✂️ Что цитировать</b>

    • <b>Частичная цитата</b> — когда отвечаешь на выделенный фрагмент: <i>Рамка</i> показывает его с рамкой цитаты, <i>Без рамки</i> — только текст, <i>Всё сообщение</i> игнорирует выделение.
    • <b>Показ reply</b> — добавлять сообщение, на которое отвечают.
    • <b>Медиа</b> — добавлять фото/видео из сообщения.
    • <b>Обрезать медиа</b> — обрезать высокие медиа.
    • <b>Роль автора</b> — показывать админский титул / подпись отправителя (маленькая метка вверху справа).
qs-cat-privacy-desc =
    <b>🔒 Приватность</b>

    • <b>Приватность</b> — сохранённые цитаты не привязываются к автору (не появятся под его именем в приложении). На сам стикер не влияет.
    • <b>Поиск отправителя</b> — пытаться определить настоящего автора пересланного сообщения, чей аккаунт скрыт.
qs-cat-group-desc =
    <b>👥 Группа</b>

    • <b>Оценки</b> — показывать кнопки 👍/👎 под цитатами.
    • <b>Авто-цитата</b> — иногда подкидывать топовую цитату в активный момент.
    • <b>Архив текста</b> — хранить текст цитат (нужно для поиска и случайных).
...
qs-btn-reset = ↩️ Сбросить всё
qs-reset-done = Сброшено к умолчаниям
menu-features-title =
    <b>✨ Что я умею?</b>
