...
qs-title =
    ...
    Обери розділ. Зміни діють на кожну нову цитату тут.
qs-on = Увімк.
qs-off = Вимк.
qs-cat-appearance = 🎨 Вигляд
qs-cat-content = ✂️ Що цитувати
qs-cat-privacy = 🔒 Приватність
qs-cat-group = 👥 Група
qs-cat-appearance-desc =
    <b>🎨 Вигляд</b>

    • <b>Формат</b> — стікер, зображення чи PNG-файл.
    • <b>Колір</b> — фон цитати.
    • <b>Бренд емодзі</b> — як малюються емодзі (Apple, Google…).
    • <b>Емодзі стікера</b> — емодзі, прикріплене до збережених стікерів.
qs-cat-content-desc =
    <b>✂️ Що цитувати</b>

    • <b>Часткова цитата</b> — коли відповідаєш на виділений фрагмент: <i>Рамка</i> показує його з рамкою цитати, <i>Без рамки</i> — лише текст, <i>Повне повідомлення</i> ігнорує виділення.
    • <b>Показ reply</b> — додавати повідомлення, на яке відповідають.
    • <b>Медіа</b> — додавати фото/відео з повідомлення.
    • <b>Обрізати медіа</b> — обрізати високі медіа.
    • <b>Роль автора</b> — показувати адмінський титул / підпис відправника (маленька позначка вгорі праворуч).
qs-cat-privacy-desc =
    <b>🔒 Приватність</b>

    • <b>Приватність</b> — збережені цитати не привʼязуються до автора (не зʼявляться під його імʼям у застосунку). На сам стікер не впливає.
    • <b>Пошук відправника</b> — намагатися визначити справжнього автора пересланого повідомлення, чий акаунт прихований.
qs-cat-group-desc =
    <b>👥 Група</b>

    • <b>Оцінки</b> — показувати кнопки 👍/👎 під цитатами.
    • <b>Авто-цитата</b> — час від часу підкидати топову цитату в активний момент.
    • <b>Архів тексту</b> — зберігати текст цитат (потрібно для пошуку й випадкових).
...
qs-format-image = Зображення
qs-format-png = PNG-файл
...
qs-btn-reset = ↩️ Скинути все
qs-reset-done = Скинуто до дефолтів
menu-features-title =
    <b>✨ Що я вмію?</b>
